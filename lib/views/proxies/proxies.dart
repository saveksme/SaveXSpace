...
// Custom FAB that looks more polished
class _StyledDelayTestButton extends StatefulWidget {
  final Future Function() onClick;
  const _StyledDelayTestButton({required this.onClick});

  @override
  State<_StyledDelayTestButton> createState() => _StyledDelayTestButtonState();
}

class _StyledDelayTestButtonState extends State<_StyledDelayTestButton>
  ...
  Widget build(BuildContext context) {
    ...
    return FloatingActionButton.extended(
      ...
      icon: RotationTransition(
        turns: _controller,
        child: const Icon(Icons.network_ping, size: 18),
      ),
      label: Text(
