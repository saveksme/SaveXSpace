...
const appName = 'SaveX Space';
const appHelperService = 'SaveXSpaceHelperService';
...
const repository = 'chen08209/FlClash'; // TODO: update to your repo
...
const defaultPrimaryColor = 0xFF9C27B0; // Purple accent matching SaveX Space logo
...
final mainIsolate = 'SaveXSpaceMainIsolate';

final serviceIsolate = 'SaveXSpaceServiceIsolate';

const defaultPrimaryColors = [
  0xFF9C27B0, // Purple (default)
  0xFF7B1FA2, // Deep Purple
  0xFFAB47BC, // Light Purple
  0xFF6A1B9A, // Dark Purple
  0xFF8E24AA, // Medium Purple
  0xFFCE93D8, // Pastel Purple
  0xFF4A148C, // Very Dark Purple
];
